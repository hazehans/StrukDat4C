...
public class Mahasiswa {
    ...
    public static void main(String[] args) {
        ...
        mhs.put("2", new Mahasiswa("Agus", "3A", "Matematika", 20202017));
        mhs.put("3", new Mahasiswa("Arro", "3D", "Pemrograman", 2022020));
...
Masukkan ID :
1
Data Mahasiswa : Putri, kelas : 3H, mata kuliah praktikum : Struktur Data, nim : 2020000
